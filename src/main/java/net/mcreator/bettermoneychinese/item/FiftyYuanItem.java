...
public class FiftyYuanItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:fifty_yuan")
	public static final Item block = null;

	public FiftyYuanItem(BetterMoneyChineseModElements instance) {
		super(instance, 15);
	}
