...
public class OneYuanItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:one_yuan")
	public static final Item block = null;

	public OneYuanItem(BetterMoneyChineseModElements instance) {
		super(instance, 8);
	}
