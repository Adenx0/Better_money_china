...
public class FiveAngleItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:five_angle")
	public static final Item block = null;

	public FiveAngleItem(BetterMoneyChineseModElements instance) {
		super(instance, 7);
	}
