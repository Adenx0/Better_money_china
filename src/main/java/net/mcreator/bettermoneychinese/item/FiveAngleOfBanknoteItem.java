...
public class FiveAngleOfBanknoteItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:five_angle_of_banknote")
	public static final Item block = null;

	public FiveAngleOfBanknoteItem(BetterMoneyChineseModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("five_angle_of_banknote");
		}
