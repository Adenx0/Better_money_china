...
public class FiveYuanItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:five_yuan")
	public static final Item block = null;

	public FiveYuanItem(BetterMoneyChineseModElements instance) {
		super(instance, 12);
	}
