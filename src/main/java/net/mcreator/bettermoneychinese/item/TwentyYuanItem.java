...
public class TwentyYuanItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:twenty_yuan")
	public static final Item block = null;

	public TwentyYuanItem(BetterMoneyChineseModElements instance) {
		super(instance, 14);
	}
