...
public class OneAngleOfBanknotesItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:one_angle_of_banknotes")
	public static final Item block = null;

	public OneAngleOfBanknotesItem(BetterMoneyChineseModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("one_angle_of_banknotes");
		}
