...
public class FiveSentsItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:five_sents")
	public static final Item block = null;

	public FiveSentsItem(BetterMoneyChineseModElements instance) {
		super(instance, 6);
	}
