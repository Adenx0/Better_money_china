...
public class OneHundredYuanItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:one_hundred_yuan")
	public static final Item block = null;

	public OneHundredYuanItem(BetterMoneyChineseModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("one_hundred_yuan");
		}
