...
public class TwoYuanItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:two_yuan")
	public static final Item block = null;

	public TwoYuanItem(BetterMoneyChineseModElements instance) {
		super(instance, 9);
	}
