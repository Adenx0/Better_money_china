...
public class OneArmorItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:one_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("better_money_chinese:one_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("better_money_chinese:one_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("better_money_chinese:one_armor_boots")
	public static final Item boots = null;

	public OneArmorItem(BetterMoneyChineseModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{10, 1000, 1000, 1000}[slot.getIndex()];
			}
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(OneHundredYuanItem.block));
			}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT).isImmuneToFire()) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "better_money_chinese:textures/models/armor/one_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
					}
				}.setRegistryName("one_armor_helmet"));
		elements.items
				...
				}.setRegistryName("one_armor_chestplate"));
		elements.items
				...
				}.setRegistryName("one_armor_leggings"));
		elements.items
				...
				}.setRegistryName("one_armor_boots"));
	}
