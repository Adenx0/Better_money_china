...
public class ThreeYuanItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:three_yuan")
	public static final Item block = null;

	public ThreeYuanItem(BetterMoneyChineseModElements instance) {
		super(instance, 10);
	}
