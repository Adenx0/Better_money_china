...
public class OneAngleOfCoinItem extends BetterMoneyChineseModElements.ModElement {
	@ObjectHolder("better_money_chinese:one_angle_of_coin")
	public static final Item block = null;

	public OneAngleOfCoinItem(BetterMoneyChineseModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("one_angle_of_coin");
		}
